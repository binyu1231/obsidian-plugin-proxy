...
import { DataConfigProxyItem, IpcRendererSendType, ProxyRequestConfig, proxyRequestMatchRegex, proxyRequestReplaceHostMap, ProxyRequestType } from './type'

function matchUrl (e?: any) {
	let type = ProxyRequestType.Unknown
	if (!e || typeof e.url !== 'string') return type
